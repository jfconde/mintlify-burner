...
The **organization context** represents your Payrails account and consolidates all [workspaces](/docs/set-up-your-payrails-account-and-environment/workspaces) under a single organizational structure.
This update simplifies navigation, centralizes settings, and enhances role-based permissions (see: [User Roles & Permissions](/docs/set-up-your-payrails-account-and-environment/user-management/index)).

## Key Features

1. **Global insights**
   Analyze aggregated data from all workspaces, with filters for workspace-specific details.
2. **Improved [User Roles & Permissions](/docs/set-up-your-payrails-account-and-environment/user-management/index) system**
