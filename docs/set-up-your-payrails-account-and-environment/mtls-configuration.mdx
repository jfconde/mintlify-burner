...
<img class="mx-auto block" width="80%" src="/images/docs/mtls-certificates-list-empty.png" />
...
3. Provide organization details to generate the CSR command:
  ...
  <img class="mx-auto block" width="80%" src="/images/docs/mtls-csr-organization-details.png" />
...
4. Generate your private key and CSR:
  ...
  <img class="mx-auto block" width="80%" src="/images/docs/mtls-csr-command-generated.png" />
...
6. The certificate is issued automatically after submission: click `Download` to download it.
  ...
  <img class="mx-auto block" width="80%" src="/images/docs/mtls-certificate-issued-download.png" />
...
<img class="mx-auto block" width="80%" src="/images/docs/mtls-test-configure-overview.png" />

<img class="mx-auto block" width="80%" src="/images/docs/mtls-test-configure-curl.png" />

<img class="mx-auto block" width="80%" src="/images/docs/mtls-test-configure-postman.png" />
...
- `domain.pem`: the certificate file [downloaded](/docs/orchestration/getting-started#request-and-manage-mtls-certificates) (or sent to you) in Step 2,
...
- `Client ID` and `Client Secret` are the API credentials. [See how to retrieve them](api-credentials#obtaining-api-credentials).

### Configure Postman to use mTLS

From certificate details

<img class="mx-auto block" width="80%" src="/images/docs/mtls-certificate-details-postman-setup.png" />
...
- Maximum number of active certificates reached: we limit the number of certificates to prevent abuse. If you reached your limit, either revoke an existing certificate that is no longer in use or contact your Payrails administrator to increase your limit.
  ...
  <img class="mx-auto block" width="40%" src="/images/docs/mtls-certificate-limit-warning.png" />

## Why is my certificate marked as Deprecated?

<img class="mx-auto block" width="80%" src="/images/docs/mtls-certificate-deprecated-status.png" />
