...
After you choose an approach, start on the client-side implementation. The [SDK guide](checkout-sdks/index) explains how to get started, and each SDK type has its own guide: [Drop-in](checkout-sdks/web/drop-in), [Elements](checkout-sdks/web/elements), and [Secure Fields](checkout-sdks/web-v5-legacy/secure-fields).
