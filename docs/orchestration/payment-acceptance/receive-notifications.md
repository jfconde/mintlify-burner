...
<img
    ...
    src="/images/docs/orchestration/payment-acceptance/notifications-portal-settings.png"
    width="80%"
/>
...
<Warning>
  A 200 response is mandatory. If any other response code is received OR no acknowledgment is received, the notification attempt is considered failed and the notification will be retried automatically with an exponential backoff.
</Warning>
