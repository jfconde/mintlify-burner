...
- See the [Getting Started](how-to-integrate#getting-started-with-the-sdk) guide for provider setup.
...
- Elements must be rendered inside a `PayrailsProvider`. See the [Getting Started](how-to-integrate#getting-started-with-the-sdk) guide for provider setup.
...
For payment completion mode options (polling, background polling, return URLs), see [Payment Completion Modes](how-to-integrate#payment-completion-modes).
