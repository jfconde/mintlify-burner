...
- **[Drop-in](doc:drop-in)**: an all-in-one payment form to accept payments on your website.
- **[Elements](doc:elements)**: modular payment UI components you can assemble to build a modular payment form.
- **[Secure fields](doc:secure-fields)**: secure input fields for PCI-compliant cardholder data collection.
