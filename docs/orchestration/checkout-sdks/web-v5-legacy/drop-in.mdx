...
| :---------------------------- | :----- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `paymentMethodsConfiguration` | Object | Payment method configurations that are needed to customize the drop-in behavior. Read more [here](/docs/orchestration/checkout-sdks/web/drop-in#payment-methods-behavior-and-configurations). |
| `events`                      | Object | Attach your callables to the events emitted by the Drop-in. Read more [here](/docs/orchestration/checkout-sdks/web/drop-in#event-listener).                                                   |
| `styles`                      | Object | Styles that should be applied to the Drop-in. Read more [here](/docs/orchestration/checkout-sdks/web/drop-in#styling).                                                                        |
| `translations`                | Object | Translations to localize the Drop-in. Read more [here](/docs/orchestration/checkout-sdks/web/drop-in#translations).                                                                           |
