...
- [`session.update()` API Reference](./api-reference#sessionupdatechanges) — full parameter and exception reference
- [`PayrailsUpdate` API Reference](./api-reference#payrailsupdate) — extensible update container
- [`AmountUpdate` API Reference](./api-reference#amountupdate) — amount and currency fields
