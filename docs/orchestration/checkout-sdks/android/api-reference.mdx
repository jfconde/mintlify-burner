...
description: This document describes the public API surface of the Payrails Android SDK, including payment methods, configuration, styling, translations, and event delegates. For setup and dependencies, see the [Quick Start](./index).
---

> **Looking for guides?** [Quick Start](./index) | [Styling Guide](./styling-guide) | [Troubleshooting](./troubleshooting) | [SDK Concepts](./sdk-concepts)
...
See [How to Build a Custom Pay Button](./how-to-custom-pay-button) for a full
...
- **Look** — `CardFormStylesConfig.cardBrandSelector: CardBrandSelectorStyle?`; see the [Card Brand Selector styling reference](./styling-guide#card-brand-selector).
...
- **[How to Tokenize a Card](./how-to-tokenize-card)** — Save a card without charging the customer
- **[How to Accept Redirect Payments](./how-to-accept-redirect-payments)** — Accept iDEAL, Bancontact, Sofort, and other redirect-based methods
- **[How to Update the Checkout Amount](./update-checkout-amount)** — Apply tips, discounts, or shipping costs after session creation
- **[Styling Guide](./styling-guide)** — Customize form and button appearance
- **[SDK Concepts](./sdk-concepts)** — Architecture, payment flows, 3DS, security model
