...
- [SDK Concepts — PayPal Payment](./sdk-concepts#paypal-payment) — How the PayPal redirect flow works
- [API Reference — PayPalButton](./api-reference#paypalbutton) — Complete `PayPalButton` API
- [Quick Start](./index) — Session initialization
