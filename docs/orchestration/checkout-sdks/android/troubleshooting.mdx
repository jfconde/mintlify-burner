...
1. Check the [API Reference](./api-reference#results-and-errors) for specific error types and delegate behavior
2. Review the [SDK Concepts](./sdk-concepts) to verify your integration pattern
3. Check the [API Reference](./api-reference) for correct method signatures
