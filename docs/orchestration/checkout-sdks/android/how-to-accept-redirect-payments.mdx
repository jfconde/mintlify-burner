...
- [How to Accept PayPal Payments](./how-to-accept-paypal-payments) — PayPal uses the same redirect infrastructure
- [SDK API Reference](./api-reference) — Full API details for redirect payments
- [Quick Start](./index) — Get started with the SDK
- [SDK Concepts](./sdk-concepts) — Payment flow architecture
