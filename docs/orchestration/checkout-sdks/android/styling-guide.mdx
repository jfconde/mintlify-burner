...
For [co-branded cards](/docs/sdk-concepts#co-branded-cards), the Card Brand selector renders automatically inside the card form. Style it via `CardFormStylesConfig.cardBrandSelector`; localize the title/subtitle via `CardTranslations`.
...
- **[Quick Start](/docs/android-sdk-1)** — Get a basic integration working first
- **[API Reference](/docs/sdk-api-reference)** — Full property reference for all style classes
- **[SDK Concepts](/docs/sdk-concepts)** — Understand element composition and button modes
