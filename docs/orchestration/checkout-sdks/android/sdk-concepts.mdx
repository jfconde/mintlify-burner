...
[`ActionResult`](/docs/sdk-api-reference#actionresult) is always terminal, with no "pending
...
The SDK never logs raw card data, tokens, or PII through either channel. See [Troubleshooting](/docs/troubleshooting#enabling-sdk-debug-logs) for how to enable Logcat output during development.
...
- **[How to Accept PayPal Payments](/docs/how-to-accept-paypal-payments)** — PayPal redirect flow and stored instruments
- **[How to Accept Redirect Payments](/docs/how-to-accept-redirect-payments)** — iDEAL, Bancontact, Sofort, and other redirect methods
- **[How to Tokenize a Card](/docs/how-to-tokenize-card)** — Save a card to vault without charging it
- **[Troubleshooting](/docs/troubleshooting)** — Common issues and solutions
- **[Styling Guide](/docs/styling-guide)** — Customize the look and feel
- **[API Reference](/docs/sdk-api-reference)** — Complete public API documentation
