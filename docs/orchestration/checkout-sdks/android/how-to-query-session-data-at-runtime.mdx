...
The current checkout amount as a [`PayrailsAmount`](/docs/sdk-api-reference#payrailsamount).
...
[`PayrailsLink`](/docs/sdk-api-reference#payrailslink).
...
[`PayrailsPaymentMethodConfig`](/docs/sdk-api-reference#payrailspaymentmethodconfig).
...
[`session.getPaymentMethodConfig(PaymentMethodFilter.Redirect)`](/docs/sdk-api-reference#sessiongetpaymentmethodconfigfilter):
...
See [How to Accept Redirect Payments](/docs/how-to-accept-redirect-payments) for the full
integration guide.
...
- [How to update the checkout amount after session creation](/docs/update-checkout-amount)
- [`Session.query()` API reference](/docs/sdk-api-reference#sessionquerykey)
- [`Session.getPaymentMethodConfig()` API reference](/docs/sdk-api-reference#sessiongetpaymentmethodconfigfilter)
