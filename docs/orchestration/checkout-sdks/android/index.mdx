...
- **[How to Tokenize a Card](/docs/how-to-tokenize-card)** — Save a card to vault without charging it (for wallets, subscriptions, and save-for-later flows)
- **[How to Let Shoppers Choose a Card Network](/docs/how-to-co-branded-cards)** — Co-branded (co-badged) cards: surface the brand selector and submit the preferred scheme
- **[How to Build a Custom Pay Button (Your Own UI)](/docs/how-to-custom-pay-button)** — Use your own button and method selector while the SDK runs the payment flow
- **[How to Run a Payment Without an SDK Button (Headless)](/docs/how-to-execute-payment-headless)** — Drive checkout from your own UI / `ViewModel` with `PayrailsPaymentLauncher`
- **[Styling Guide](/docs/styling-guide)** — Customize colors, fonts, and layout to match your brand
- **[Troubleshooting](/docs/troubleshooting)** — Diagnose integration and runtime issues
- **[SDK Concepts](/docs/sdk-concepts)** — Understand the architecture and mental model
- **[API Reference](/docs/sdk-api-reference)** — Complete reference for all public APIs
