...
> Background: [Co-Branded Cards](./sdk-concepts#co-branded-cards).

## Prerequisites

- An active Payrails session (see [Quick Start](./index)) rendering a `CardForm` + `CardPaymentButton`.
...
See the [Card Brand Selector styling reference](./styling-guide#card-brand-selector) for all tokens.
...
See [`Session.binLookup`](./api-reference#co-branded-cards) for the full contract.

## Related

- [Co-Branded Cards (concept)](./sdk-concepts#co-branded-cards)
- [API Reference — Co-Branded Cards](./api-reference#co-branded-cards)
- [Styling Guide — Card Brand Selector](./styling-guide#card-brand-selector)
