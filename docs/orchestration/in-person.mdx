...
Your **Webhook server** also receives notifications that inform you about the outcome of each payment, [just like for online payments via Payrails](/docs/orchestration/payment-acceptance/receive-notifications).
