...
2. Configure a new [integration account](/docs/orchestration/integrations/index) for PayJustNow via [PayJustNow](./payjustnow-psp)
...
The simplest way to use PayJustNow with Payrails is to use our [drop-in](/docs/orchestration/checkout-sdks/web-v5-legacy/drop-in) in your checkout flow. With this integration type, no additional development work is required to accept payments with PayJustNow.
