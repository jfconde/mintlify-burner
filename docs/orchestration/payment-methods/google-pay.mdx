...
The simplest way to use Google Pay with Payrails is to use our [drop-in](/docs/orchestration/checkout-sdks/web/drop-in) in your checkout flow. With this integration type, no additional work is required to accept payments with Google Pay.

For a more flexible implementation using our SDK, you can use our Google Pay element. See special instructions [here](/docs/orchestration/checkout-sdks/web/elements#google-pay-element) for your client-side implementation.
