...
2. Configure a new [integration account](/docs/orchestration/integrations/index) for [Mercado Pago](./mercadopago-psp).
...
The simplest way to use MercadoPago with Payrails is to use our [drop-in](/docs/orchestration/checkout-sdks/web-v5-legacy/drop-in) in your checkout flow. With this integration type, no additional work is required to accept payments with MercadoPago **_except_** _for handling success/failure screens for your users_.

For a more flexible implementation using our SDK, you can use our MercadoPago's (genericRedirectButton) element. See **special instructions** [here](/docs/orchestration/checkout-sdks/web-v5-legacy/elements#generic-redirect-element) for your client-side implementation.
