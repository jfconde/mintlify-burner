...
The simplest way to use SPEI with Payrails is to use our [drop-in](/docs/orchestration/checkout-sdks/web/drop-in) in your checkout flow. With this integration type, no additional work is required to accept payments with SPEI except for handling success/failure screens for your users.
