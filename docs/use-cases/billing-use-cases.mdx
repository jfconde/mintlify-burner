...
- Use [Drop-in](/docs/orchestration/checkout-sdks/web-v5-legacy/drop-in) for a pre-built payment UI:
- Use [Elements](/docs/orchestration/checkout-sdks/web-v5-legacy/elements) for individual UI building blocks
