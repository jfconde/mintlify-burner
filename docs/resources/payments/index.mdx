...
| Code                  | Description                                                                                                                                                     | Retryable |
| :-------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------- |
| GENERIC_REJECTION     | The provider (or any of the actors in the chain) reject the transaction but do not specify a specific reason. This code is often referred to as "do not honor". | `false`   |
...
| PARAMS_ERROR          | After sending the transaction to the provider, they decided not to execute it because of a problem with the parameters we sent. Could be a required field is missing, incorrectly formatted, etc. | `false`   |
