...
Once an operation of a specific [Operation Type](./operation-types) was executed, and we interpreted its [Result Code](./operation-results), we are ready to change the status of the actual payment.
