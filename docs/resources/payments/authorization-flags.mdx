...
This document explains the different payment processing types and instrument future usage for the [Authorize a payment API](ref:authorizeaction) reference. For a more detailed walkthrough, refer to the [Authorize a payment guide](/docs/orchestration/payment-acceptance/authorize-a-payment).
