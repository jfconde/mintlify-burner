...
- Optionally, you can encrypt the card to use it in another use case, like the [Proxy payment instruments](/docs/token-vault/vault-proxy/proxy-payment-instruments/proxy-payment-instruments) feature. This feature is available as of version `v0.2.0`.
