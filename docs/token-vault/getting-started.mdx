...
If you have read our [Token Vault introduction](/docs/overview/vault) page, you already know that Payrails offers multiple ways to use our Token Vault, as a standalone module or within the Payment Orchestration with Payrails. In this section, we introduce the Vault module. If you are not sure how you want to use the vault, you can navigate to the next [section](getting-started#options-to-use-payrails-token-vault) to learn your options.
