...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| `payments`     | Gain deep insights into your authorization funnel and processing efficiency with a unified breakdown of payment statuses, failure results, and card-level metadata.. | [View schema](/docs/report-payments)     |
| `transactions` | This report provides details on all transactions which impact your account balance..                                                                                 | [View schema](/docs/report-transactions) |
| `settlements`  | This report provides a comprehensive breakdown of all transaction-level movements and associated costs that impact your merchant settlement balance..                | [View schema](/docs/report-settlements)  |
| `disputes`     | Chargeback and dispute data, linked back to the original disputed transaction where it was processed through Payrails.                                               | [View schema](/docs/report-disputes)     |
...
<Accordion title="What timezone should I use?">
  Use a [TZ database name](https://www.iana.org/time-zones) such as `Europe/Berlin` or `America/New_York`. If you omit the `timezone` parameter, it defaults to `UTC`. Choosing the right timezone ensures that day boundaries in the report align with your local business hours.
</Accordion>
