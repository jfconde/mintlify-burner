...
to your Stripe dashboard to complete this step.
...
<Tip>
  Payrails uses Stripe webhooks to receive asynchronous chargeback status
  updates.
</Tip>

<Warning>If you are using Stripe Connect, skip this part.</Warning>
